...
def tracking_linear_term(P0, qc, ql, path, spline_idx):
    ...
    cc = np.array([
                      2 * qc * ϵc0 * dϵc_dx - 2 * qc * X0 * dϵc_dx ** 2 - 2 * qc * Y0 * dϵc_dx * dϵc_dy - 2 * qc * s0 * dϵc_dx * dϵc_ds,
    ...
    cl = np.array([
                      2 * ql * ϵl0 * dϵl_dx - 2 * ql * X0 * dϵl_dx ** 2 - 2 * ql * Y0 * dϵl_dx * dϵl_dy - 2 * ql * s0 * dϵl_dx * dϵl_ds,
